...
export const productFabric = ["Jeans", "Velvet", "Cotton", "Leather", "Poliester"]
export const productGender = ["Female", "Male", "Kid"]

export const productSize = ["M", "S", "L"]

export const orderStatus = ["Accepted", "Packed", "Sent", "Cancelled"]