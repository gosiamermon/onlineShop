...
import { getAllUsers, deleteUser } from '../../../actions/users/users.action-creators'
...
export const UsersTable = connect(mapStateToProps, { getAllUsers, push, deleteUser })(UsersTableComponent)